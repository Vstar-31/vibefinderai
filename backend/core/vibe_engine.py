...
SYNONYMS: dict[str, list[str]] = {
    ...
    # ── sensory / nature / texture metaphors (NEW) ────────────────────────────
    # Positive nature imagery
    "sunflower":           ["happy", "euphoric"],
    "sunflowers":          ["happy", "euphoric"],
    "sunflower field":     ["happy", "euphoric", "calm"],
    "wildflowers":         ["happy", "calm"],
    "bloom":               ["happy", "euphoric"],
    "blooming":            ["happy", "euphoric"],
    "blossom":             ["happy", "calm"],
    "blossoming":          ["happy", "calm"],
    "petal":               ["dreamy", "calm"],
    "petals":              ["dreamy", "calm"],
    "meadow":              ["calm", "happy"],
    "garden":              ["calm", "happy"],
    "grass":               ["calm", "happy"],
    "morning light":       ["calm", "happy"],
    "golden light":        ["calm", "euphoric"],
    "warm light":          ["calm", "euphoric"],
    "soft light":          ["dreamy", "calm"],
    "dappled light":       ["dreamy", "calm"],
    "sunshine":            ["happy", "euphoric"],
    "sunny":               ["happy", "euphoric"],
    "bright day":          ["happy", "euphoric"],
    "clear sky":           ["happy", "calm"],
    "blue sky":            ["happy", "calm"],
    "rainbow":             ["happy", "euphoric"],
    "spring":              ["happy", "calm"],
    "springtime":          ["happy", "calm"],
    "summer day":          ["happy", "euphoric"],
    "warm summer":         ["happy", "tropical"],

    # Sweet / food / comfort textures
    "chocolate":           ["soulful", "happy"],
    "chocolates":          ["soulful", "happy"],
    "honey":               ["chill", "soulful"],
    "caramel":             ["soulful", "chill"],
    "vanilla":             ["calm", "happy"],
    "cinnamon":            ["calm", "soulful"],
    "warm cookie":         ["happy", "calm"],
    "cookies":             ["happy", "calm"],
    "baking":              ["happy", "calm"],
    "peach":               ["happy", "calm"],
    "peaches":             ["happy", "euphoric"],
    "strawberry":          ["happy", "euphoric"],
    "cherry":              ["happy", "euphoric"],
    "lemon":               ["happy", "euphoric"],
    "citrus":              ["happy", "euphoric"],
    "fruity":              ["happy", "euphoric"],
    "sweet":               ["happy", "soulful"],
    "sugary":              ["happy", "hyperpop"],
    "candy":               ["happy", "hyperpop"],
    "dessert":             ["happy", "soulful"],
    "warm drink":          ["calm", "soulful"],
    "hot cocoa":           ["calm", "happy"],
    "hot chocolate":       ["calm", "happy"],
    "coffee morning":      ["calm", "happy"],
    "tea":                 ["calm", "chill"],

    # Warm texture / fabric / comfort
    "cozy blanket":        ["calm", "happy"],
    "soft blanket":        ["calm", "dreamy"],
    "warm hug":            ["happy", "soulful"],
    "feels like a hug":    ["happy", "soulful"],
    "warm embrace":        ["happy", "soulful"],
    "comfortable":         ["calm", "chill"],
    "cashmere":            ["calm", "soulful"],
    "velvet":              ["soulful", "dreamy"],
    "silk":                ["calm", "soulful"],
    "linen":               ["calm", "happy"],
    "soft":                ["calm", "dreamy"],
    "fluffy":              ["happy", "calm"],
    "plush":               ["calm", "soulful"],
    "cottagecore":         ["calm", "happy"],
    "hygge":               ["calm", "happy"],

    # Colours as emotional signals
    "yellow":              ["happy", "euphoric"],
    "golden":              ["calm", "euphoric"],
    "rose gold":           ["dreamy", "happy"],
    "pastel":              ["dreamy", "calm"],
    "pink":                ["happy", "dreamy"],
    "lavender":            ["dreamy", "calm"],
    "lilac":               ["dreamy", "calm"],
    "mint":                ["calm", "happy"],
    "sage":                ["calm", "dreamy"],
    "warm colours":        ["happy", "calm"],
    "muted tones":         ["dreamy", "calm"],

    # Light / atmosphere
    "warm glow":           ["calm", "euphoric"],
    "candlelight":         ["calm", "soulful"],
    "twinkle lights":      ["dreamy", "happy"],
    "fairy lights":        ["dreamy", "happy"],
    "golden glow":         ["euphoric", "calm"],
    "hazy afternoon":      ["dreamy", "chill"],
    "lazy afternoon":      ["chill", "calm"],
    "slow morning":        ["calm", "chill"],
    "sunday morning":      ["calm", "soulful"],
    "morning coffee":      ["calm", "happy"],
    "slow sunday":         ["calm", "soulful"],
    "warm": ["calm", "soulful"],
    "mellow": ["chill", "calm"],
    "lowkey": ["chill", "calm"],
    "touch grass": ["calm"],
    ...
    # "feels" removed — pure connector word, biases all metaphor prompts to heartbreak
    ...
    # "feels like" removed — connector phrase, NOT an emotional signal on its own
    ...
    # ── v6.1: batch result gap fills ─────────────────────────────────────────
    # "exhausted" zero-match fix (→ calm/dark, not empty)
    "exhausted":           ["calm", "dark"],
    "totally exhausted":   ["calm", "dark"],
    "drained":             ["calm", "dark", "heartbreak"],
    "burnout":             ["calm", "dark"],
    "something beautiful": ["dreamy", "calm"],
    "give me something beautiful": ["dreamy", "calm"],
    "just beautiful":      ["dreamy", "calm"],
    # Faiz Ahmad Faiz → ghazal/soulful routing
    "faiz ahmad faiz":     ["soulful", "dark"],
    "faiz":                ["soulful", "dark"],
    "dimly lit room":      ["dark", "soulful"],
    "intellectual":        ["focus", "soulful"],
    "chai and cigarette":  ["dark", "soulful"],
    # Shubh / dark Punjabi
    "shubh":               ["hype", "heartbreak"],
    "bass heavy":          ["hype", "dark"],          # production descriptor, not metal
    "night out modern":    ["party", "hype"],
    # Irish pub / Celtic
    "dropkick murphys":    ["party", "rock"],
    "loud singing":        ["party", "happy"],         # pub singing context
    "pub singing":         ["party", "happy"],
    "drinking songs":      ["party", "happy"],
    "irish pub":           ["party", "indie_folk"],
    "pub night":           ["party", "happy"],
    "fiddles":             ["indie_folk", "party"],
    "hurdy gurdy":         ["indie_folk", "calm"],
    # Tamil/Telugu signals
    "thalapathy":          ["intense", "cinematic"],
    "thalapathy vijay":    ["intense", "cinematic"],
    "vijay movie":         ["intense", "cinematic"],
    "yuvan shankar raja":  ["party", "soulful"],
    "mass item":           ["party", "intense"],
    "packed theatre":      ["intense", "hype"],
    "full whistling":      ["party", "hype"],
    # Generic + language-specific safety
    "not english":         ["dreamy", "ambient"],
    "not in english":      ["dreamy", "ambient"],
    "isn't english":       ["dreamy", "ambient"],

    # ── v6.2: bug fixes from batch analysis ──────────────────────────────────

    # FIX: 'hot girl walk' → tropical misfire ('hot' was in tropical VIBE_MAP keywords)
    # Compound phrases now win before 'hot' alone can score tropical
    "hot girl walk":       ["hype", "happy"],
    "hot girl summer":     ["hype", "happy"],
    "hot girl":            ["hype", "happy"],
    "slay walk":           ["hype", "happy"],
    "confidence walk":     ["hype", "happy"],     # already in but reinforcing

    # FIX: 'german techno bunker' → intense → Deathcore
    # Explicit genre descriptor needs DIRECT_GENRE_MAP hit
    "german techno":       ["industrial", "party"],   # scores industrial for VIBE, direct tag sets hard_techno
    "techno bunker":       ["industrial", "party"],
    "bunker":              ["industrial", "dark"],

    # FIX: 'midnight anxiety + soft piano' → dark (should be calm)
    # Calm signals need more weight against dark/heartbreak from anxiety/midnight
    "soft piano":          ["calm", "dreamy", "ambient"],
    "piano music":         ["calm", "focus"],
    "need to calm":        ["calm", "ambient"],
    "need to calm down":   ["calm", "ambient"],
    "need to relax":       ["calm", "chill"],
    "calm down":           ["calm", "ambient"],
    "can't sleep":         ["calm", "dark"],       # maps to BOTH — calm should win when soft signals present
    "cannot sleep":        ["calm", "dark"],
    "sleepless":           ["dark", "calm"],
    "midnight anxiety":    ["calm", "dark"],       # compound beats 'midnight' alone

    # FIX: 'Kanye West dark fantasy' → intense → Deathcore
    # 'dark fantasy' is an album name, not a dark/intense descriptor
    "dark fantasy":        ["hype", "cinematic"],  # Kanye album — not metal
    "kanye west":          ["hype", "soulful"],
    "kanye":               ["hype", "soulful"],
    "ye":                  ["hype", "dark"],
    "donda":               ["dark", "cinematic"],
    "dark fantasy era":    ["hype", "cinematic"],
    "maximalist":          ["hype", "cinematic"],  # was hyperpop/hype, add cinematic
    "maximalist production": ["hype", "cinematic"],
    "introspective rap":   ["hype", "dark"],

    # FIX: 'morning run sunrise' → hype → Trap/Phonk (should be upbeat pop)
    # morning run context → happy/hype but with pop/dance tag not trap
    "morning run":         ["happy", "hype"],
    "morning jog":         ["happy", "hype"],
    "running playlist":    ["hype", "happy"],
    "cardio":              ["hype", "happy"],
    "city waking up":      ["happy", "chill"],

    # FIX: 'The Weeknd dark RnB, 80s synth' → retro (should be dark/romantic)
    # '80s synth' + 'neon lights' = 3 retro hits, Weeknd not in SYNONYMS
    "the weeknd":          ["dark", "romantic", "soulful"],
    "weeknd":              ["dark", "romantic"],
    "dark rnb":            ["dark", "romantic", "soulful"],
    "alternative rnb":     ["soulful", "dark"],
    "alt rnb":             ["soulful", "dark"],
    "heartbreak high":     ["heartbreak", "dark"],
    "hotel room":          ["dark", "heartbreak"],

    # FIX: sandalwood/Kannada → romantic → English neo soul
    "puneeth rajkumar":    ["romantic", "cinematic"],
    "puneeth":             ["romantic", "cinematic"],
    "sandalwood film":     ["romantic", "cinematic"],
    "kannada film":        ["romantic", "cinematic"],
    "kgf":                 ["intense", "cinematic"],
    "kgf rocky":           ["intense", "cinematic"],

    # ── v6.2: TikTok aesthetics from research (not yet in SYNONYMS) ───────────
    "goblincore":          ["dark", "indie_folk"],
    "goblin core":         ["dark", "indie_folk"],
    "fairycore":           ["dreamy", "happy"],
    "fairy core":          ["dreamy", "happy"],
    "angelcore":           ["dreamy", "calm", "euphoric"],
    "angel core":          ["dreamy", "calm"],
    "coquette":            ["dreamy", "romantic"],
    "coquette aesthetic":  ["dreamy", "romantic"],
    "barbiecore":          ["happy", "hyperpop"],
    "barbie core":         ["happy", "hyperpop"],
    "balletcore":          ["calm", "cinematic"],
    "ballet core":         ["calm", "cinematic"],
    "dreamcore":           ["dreamy", "dark"],
    "dream core":          ["dreamy", "dark"],
    "weirdcore":           ["industrial", "hyperpop"],
    "weird core":          ["industrial", "hyperpop"],
    "goblin mode":         ["dark", "chill"],
    "coastal grandmother": ["calm", "soulful"],
    "quiet luxury":        ["calm", "soulful"],
    "old money":           ["calm", "soulful", "cinematic"],
    "old money aesthetic": ["calm", "cinematic"],
    "feral girl":          ["hype", "party", "rock"],
    "that girl":           ["focus", "hype"],
    "that girl aesthetic": ["focus", "hype"],
    "dark feminine":       ["dark", "dreamy"],
    "dark femme":          ["dark", "dreamy"],
    "indie sleaze":        ["rock", "party"],
    "indie sleaze era":    ["rock", "party"],
    "gorpcore":            ["indie_folk", "calm"],
    "liminal space":       ["dark", "dreamy", "ambient"],
    "liminal":             ["dreamy", "dark"],
    "dreamcore vibes":     ["dreamy", "ambient"],
    "clowncore":           ["hyperpop", "hype"],
    "witchcore":           ["dark", "indie_folk"],
    "witch aesthetic":     ["dark", "indie_folk"],

    # ── v6.2: Gen Z phrases ──────────────────────────────────────────────────
    "understood the assignment": ["hype", "happy"],
    "delulu":              ["happy", "hyperpop"],
    "in my villain arc":   ["dark", "hype"],
    "in my healing arc":   ["calm", "happy"],
    "in my flop era":      ["heartbreak", "dark"],
    "in my glow up era":   ["hype", "happy"],
    "it's giving romance": ["romantic", "dreamy"],
    "it's giving chaos":   ["hype", "hyperpop"],
    "it's giving sadness": ["heartbreak"],
    "it's giving summer":  ["happy", "tropical"],
    "it's giving autumn":  ["heartbreak", "indie_folk"],
    "it's giving winter":  ["dark", "dreamy"],
    "serotonin":           ["happy", "euphoric"],
    "dopamine":            ["happy", "hype"],
    "roman holiday":       ["happy", "carefree"],
    "core memory":         ["heartbreak", "dreamy", "retro"],
    "situationship":       ["heartbreak", "dreamy"],
    "talking stage":       ["romantic", "dreamy"],
    "pre-drinks":          ["party", "hype"],
    "pregame":             ["party", "hype"],

    # ── v6.2: Sound descriptor vocabulary ───────────────────────────────────
    "warm analog":         ["chill", "soulful"],
    "tape saturation":     ["retro", "chill"],
    "vinyl crackle":       ["retro", "chill"],
    "reverb drenched":     ["dreamy"],
    "reverb heavy":        ["dreamy"],
    "punchy":              ["hype", "party"],
    "punchy drums":        ["hype", "intense"],
    "anthemic":            ["hype", "euphoric"],
    "soaring":             ["euphoric", "cinematic"],
    "hard-hitting":        ["hype", "intense"],
    "hard hitting":        ["hype", "intense"],
    "sparse":              ["ambient", "calm"],
    "lush":                ["dreamy", "romantic"],
    "lush production":     ["dreamy", "cinematic"],
    "propulsive":          ["hype", "rock"],
    "headphone music":     ["ambient", "focus", "dreamy"],
    "speaker music":       ["party", "hype"],
    "808s":                ["hype", "dark"],
    "808 bass":            ["hype", "dark"],
    "trap hi-hats":        ["hype"],
    "four-on-the-floor":   ["party", "industrial"],
    "vocal chops":         ["hype", "party"],
    "no lyrics":           ["ambient", "focus"],
    "instrumental only":   ["ambient", "focus"],
    "purely instrumental": ["ambient", "focus"],
    "heavy bass":          ["hype", "dark"],     # was mapped to hype/dark, reinforcing
    "sub bass":            ["dark", "industrial"],
    "cinematic scope":     ["cinematic"],
    "stadium sound":       ["hype", "euphoric", "cinematic"],
    "intimate":            ["indie_folk", "calm"],
    "raw production":      ["rock", "indie_folk"],
    "lo-fi vibes":         ["chill", "focus"],
    "hi-fi":               ["focus", "soulful"],

    # ── v6.2: Activity context gaps ──────────────────────────────────────────
    "yoga":                ["calm", "ambient"],
    "meditation session":  ["calm", "ambient"],
    "hiking":              ["indie_folk", "calm"],
    "trail run":           ["hype", "happy"],
    "beach walk":          ["calm", "tropical"],
    "commute":             ["chill", "focus"],
    "cooking":             ["happy", "chill"],
    "cleaning":            ["hype", "happy"],
    "journaling":          ["calm", "heartbreak"],
    "late night scrolling":["dark", "chill"],
    "doom scrolling":      ["dark", "chill"],
    "nap time":            ["calm", "ambient"],
    "rainy sunday":        ["chill", "heartbreak"],
    "sunday reset":        ["calm", "chill"],
    "golden hour":         ["calm", "euphoric"],  # already there, reinforcing

    # ── v6.2: Emotion vocabulary from Berkeley/GEMS research ────────────────
    "transcendent":        ["euphoric", "dreamy"],
    "sublime":             ["dreamy", "calm", "euphoric"],
    "wistful":             ["heartbreak", "dreamy"],
    "forlorn":             ["heartbreak", "dark"],
    "bereft":              ["heartbreak"],
    "unmoored":            ["dark", "heartbreak"],
    "adrift":              ["heartbreak", "dreamy"],
    "desolate":            ["dark", "heartbreak"],
    "seething":            ["intense", "dark"],
    "simmering":           ["dark", "intense"],
    "defiant":             ["rock", "intense"],
    "triumphant":          ["euphoric", "hype"],
    "triumphant feeling":  ["euphoric", "cinematic"],
    "victorious":          ["hype", "euphoric"],
    "pumped up":           ["hype"],
    "fired up":            ["hype", "intense"],
    "blissful":            ["euphoric", "happy"],
    "serene":              ["calm"],
    "tranquil":            ["calm", "ambient"],
    "tender":              ["romantic", "calm"],
    "bittersweet feeling": ["heartbreak", "dreamy"],
    "aching":              ["heartbreak", "soulful"],
    "yearning":            ["heartbreak", "dreamy"],
    "longing":             ["heartbreak", "dreamy"],

    # ── v6.3: research stragglers + 2024 TikTok/cultural terms ───────────────

    # Remaining aesthetic gaps
    "sad girl autumn":     ["heartbreak", "indie_folk"],
    "sad girl fall":       ["heartbreak", "indie_folk"],
    "chaos goblin":        ["hype", "rock", "hyperpop"],
    "kidcore":             ["happy", "hyperpop"],
    "light academia":      ["calm", "focus"],
    "light academia vibes":["calm", "focus"],
    "crying in the shower":["heartbreak"],
    "crying in my car":    ["heartbreak", "dreamy"],

    # 2024 TikTok eras and aesthetics
    "brat summer":         ["hype", "party"],
    "brat green":          ["hype", "hyperpop"],
    "demure":              ["calm", "soulful"],
    "very demure":         ["calm", "soulful"],
    "very mindful":        ["calm", "focus"],
    "clean girl":          ["calm", "focus"],
    "clean girl aesthetic":["calm", "focus"],
    "mob wife":            ["dark", "hype"],
    "mob wife aesthetic":  ["dark", "hype", "cinematic"],
    "office siren":        ["hype", "dark", "cinematic"],
    "tenniscore":          ["happy", "indie_folk"],
    "ballet flats aesthetic":["calm", "cinematic"],
    "tomato girl":         ["happy", "tropical"],
    "tomato girl summer":  ["happy", "tropical"],
    "mermaidcore":         ["dreamy", "calm"],
    "fairygrunge":         ["dark", "indie_folk"],
    "blokecore":           ["rock", "retro"],
    "coastal cowgirl":     ["country", "happy"],
    "understood the assignment":["hype", "happy"],
    "no skip album":       ["soulful", "focus"],
    "hits different":      ["heartbreak", "dreamy"],
    "rent free in my head":["hype", "happy"],
    "stuck in my head":    ["hype", "happy"],
    "girl dinner":         ["chill", "happy"],
    "roman empire":        ["cinematic", "intense"],
    "delulu era":          ["happy", "hyperpop"],

    # More activity phrases
    "study with me":       ["focus", "calm"],
    "study grind":         ["focus", "dark"],
    "night drive alone":   ["dark", "chill"],
    "solo road trip":      ["chill", "dreamy"],
    "working from home":   ["focus", "chill"],
    "wfh playlist":        ["focus", "chill"],
    "gym day":             ["hype", "intense"],
    "leg day":             ["hype", "intense"],
    "getting ready out":   ["hype", "party"],
    "sunday reset":        ["calm", "chill"],
    "friday night":        ["party", "hype"],
    "late night thoughts": ["dark", "chill"],
    "midnight thoughts":   ["dark", "heartbreak"],
    "shower thoughts":     ["chill", "dreamy"],
    "airport vibes":       ["dreamy", "chill"],
    "long flight":         ["dreamy", "ambient"],

    # Hinglish gaps from research
    "sunne wala":          ["chill", "focus"],
    "feel aata hai":       ["soulful", "heartbreak"],
    "woh wala feel":       ["heartbreak", "dreamy"],
    "hostel wali raat":    ["heartbreak", "happy"],
    "college wala time":   ["retro", "happy"],
    "college wali feeling":["retro", "happy"],
    "hostel memories":     ["heartbreak", "happy"],
    "farewell wala mood":  ["heartbreak", "soulful"],
    "road trip wala":      ["chill", "happy"],
    "metro mein sunna":    ["chill", "focus"],
    "exam ke baad":        ["happy", "euphoric"],
    "baarish ke din":      ["romantic", "chill"],
    "garam chai ke saath": ["chill", "calm"],
    "ghar ki yaad":        ["heartbreak", "soulful"],

    # 2024 emerging artists (not yet in SYNONYMS)
    "sabrina carpenter":   ["happy", "romantic"],
    "chappell roan":       ["hype", "euphoric"],
    "gracie abrams":       ["heartbreak", "indie_folk"],
    "beabadoobee":         ["dreamy", "indie_folk"],
    "ethel cain":          ["dark", "cinematic"],
    "laufey":              ["romantic", "calm", "soulful"],
    "lucy dacus":          ["heartbreak", "indie_folk"],
    "boygenius":           ["heartbreak", "indie_folk"],
    "tv girl":             ["chill", "dreamy", "retro"],
    "mk.gee":              ["chill", "dreamy"],
    "men i trust":         ["dreamy", "chill"],
    "beach bunny":         ["indie_folk", "happy"],
    "snail mail":          ["heartbreak", "indie_folk"],
    "japanese breakfast":  ["heartbreak", "dreamy"],
    "alex g":              ["indie_folk", "dreamy"],
    "adrianne lenker":     ["heartbreak", "indie_folk"],
    "weyes blood":         ["cinematic", "dreamy", "soulful"],
    "arooj aftab":         ["soulful", "dreamy", "calm"],
    "wet leg":             ["rock", "indie_folk"],
    "amaarae":             ["tropical", "chill"],
    "omah lay":            ["romantic", "chill"],
    "black sherif":        ["intense", "soulful"],
    "fally ipupa":         ["party", "tropical"],
    "summer walker":       ["soulful", "romantic", "heartbreak"],
    "ravyn lenae":         ["soulful", "dreamy"],
    "omar apollo":         ["romantic", "soulful"],
    "benson boone":        ["heartbreak", "hype"],
    "noah kahan":          ["indie_folk", "heartbreak"],
    "doechii":             ["hype", "intense"],
    "tyler the creator":   ["chill", "hype", "soulful"],
    "blood orange":        ["soulful", "dreamy"],
    "jpegmafia":           ["hype", "intense"],
    "billy woods":         ["dark", "intense"],
    "injury reserve":      ["dark", "intense"],
    "black midi":          ["rock", "intense"],
    "yard act":            ["rock", "dark"],
    "dry cleaning":        ["indie_folk", "dark"],
}
...
DIRECT_GENRE_MAP: dict[str, dict] = {
    ...
    "marathi indie":       {"tag": "marathi",            "vibe": "indie_folk", "lang": "Marathi"},
    "marathi lavani":      {"tag": "lavani",             "vibe": "party",      "lang": "Marathi"},
    "lavani":              {"tag": "lavani",             "vibe": "party",      "lang": "Marathi"},
    "garba":               {"tag": "bollywood edm",     "vibe": "party",      "lang": "Marathi"},
    "dandiya":             {"tag": "bollywood edm",     "vibe": "party",      "lang": "Marathi"},
    "navratri":            {"tag": "bollywood edm",     "vibe": "party",      "lang": "Hindi"},
    "navratri garba":      {"tag": "bollywood edm",     "vibe": "party",      "lang": "Hindi"},
    "garba remix":         {"tag": "bollywood edm",     "vibe": "party",      "lang": "Hindi"},
    "bhajan clubbing":     {"tag": "bollywood edm",     "vibe": "euphoric",   "lang": "Hindi"},
    ...
    # Telugu mass
    "telugu mass item":    {"tag": "tollywood mass",     "vibe": "party",      "lang": "Telugu"},
    "mass item song":      {"tag": "tollywood mass",     "vibe": "party",      "lang": "Telugu"},
    "packed theatre":      {"tag": "tollywood mass",     "vibe": "intense",    "lang": "Telugu"},
    "thalapathy":          {"tag": "kollywood action",   "vibe": "intense",    "lang": "Tamil"},
    "thalapathy vijay":    {"tag": "kollywood action",   "vibe": "intense",    "lang": "Tamil"},
    # Irish / Celtic pub — prevent loud → deathcore misfire
    "irish pub":           {"tag": "celtic punk",        "vibe": "party",      "lang": "English"},
    "pub drinking":        {"tag": "celtic punk",        "vibe": "party",      "lang": "English"},
    "pub drinking song":   {"tag": "celtic punk",        "vibe": "party",      "lang": "English"},
    "irish pub song":      {"tag": "celtic punk",        "vibe": "party",      "lang": "English"},
    "dropkick murphys":    {"tag": "celtic punk",        "vibe": "party",      "lang": "English"},
    "murphys":             {"tag": "celtic punk",        "vibe": "party",      "lang": "English"},
    "fiddles playing":     {"tag": "celtic folk",        "vibe": "party",      "lang": "English"},
    "drinking songs":      {"tag": "celtic folk",        "vibe": "party",      "lang": "English"},
    "pirate tavern":       {"tag": "sea shanty",         "vibe": "indie_folk", "lang": "English"},
    "hurdy gurdy":         {"tag": "folk",               "vibe": "indie_folk", "lang": "English"},
    # Dark Punjabi (Shubh-style moody trap) — prevent dark → deathcore misfire
    "dark punjabi":        {"tag": "punjabi trap",       "vibe": "hype",       "lang": "Punjabi"},
    "punjabi trap":        {"tag": "punjabi trap",       "vibe": "hype",       "lang": "Punjabi"},
    "shubh":               {"tag": "punjabi trap",       "vibe": "hype",       "lang": "Punjabi"},
    ...
    # v6.2: new DIRECT_GENRE_MAP entries from batch analysis gaps
    "german techno":       {"tag": "hard techno",        "vibe": "industrial", "lang": "English"},
    "techno bunker":       {"tag": "hard techno",        "vibe": "industrial", "lang": "English"},
    "dark rnb":            {"tag": "alternative r&b",    "vibe": "dark",       "lang": "English"},
    "dark r&b":            {"tag": "alternative r&b",    "vibe": "dark",       "lang": "English"},
    "alternative r&b":     {"tag": "alternative r&b",    "vibe": "soulful",    "lang": "English"},
    "alt r&b":             {"tag": "alternative r&b",    "vibe": "soulful",    "lang": "English"},
    "the weeknd":          {"tag": "alternative r&b",    "vibe": "dark",       "lang": "English"},
    "weeknd":              {"tag": "alternative r&b",    "vibe": "dark",       "lang": "English"},
    "morning run":         {"tag": "dance pop",          "vibe": "happy",      "lang": "English"},
    "running playlist":    {"tag": "dance pop",          "vibe": "happy",      "lang": "English"},
    "kanye west":          {"tag": "hip-hop",            "vibe": "hype",       "lang": "English"},
    "kanye":               {"tag": "hip-hop",            "vibe": "hype",       "lang": "English"},
    "dark fantasy era":    {"tag": "hip-hop",            "vibe": "hype",       "lang": "English"},
    "sandalwood":          {"tag": "kannada",            "vibe": "romantic",   "lang": "Kannada"},
    "puneeth rajkumar":    {"tag": "kannada",            "vibe": "romantic",   "lang": "Kannada"},
    "tollywood romantic":  {"tag": "tollywood romantic", "vibe": "romantic",   "lang": "Telugu"},
    "telugu love song":    {"tag": "tollywood romantic", "vibe": "romantic",   "lang": "Telugu"},
    "yacht rock":          {"tag": "yacht rock",         "vibe": "calm",       "lang": "English"},
    "coastal grandmother": {"tag": "yacht rock",         "vibe": "calm",       "lang": "English"},
    "sophisti-pop":        {"tag": "sophisti-pop",       "vibe": "calm",       "lang": "English"},
    "new wave":            {"tag": "new wave",           "vibe": "retro",      "lang": "English"},
    "post punk revival":   {"tag": "post-punk",          "vibe": "rock",       "lang": "English"},
    "indie sleaze":        {"tag": "indie rock",         "vibe": "rock",       "lang": "English"},
    "witch house":         {"tag": "witch house",        "vibe": "dark",       "lang": "English"},
    "hypnagogic pop":      {"tag": "hypnagogic pop",     "vibe": "dreamy",     "lang": "English"},
    "deconstructed club":  {"tag": "experimental",       "vibe": "industrial", "lang": "English"},
    "digicore":            {"tag": "hyperpop",           "vibe": "hyperpop",   "lang": "English"},
    "footwork":            {"tag": "footwork",           "vibe": "intense",    "lang": "English"},
    "juke":                {"tag": "footwork",           "vibe": "intense",    "lang": "English"},
    "liquid drum and bass":{"tag": "liquid drum and bass","vibe": "chill",     "lang": "English"},
    "neurofunk":           {"tag": "neurofunk",          "vibe": "dark",       "lang": "English"},
    "atmospheric drum and bass":{"tag": "atmospheric drum and bass","vibe":"dreamy","lang":"English"},
    "speed garage":        {"tag": "speed garage",       "vibe": "party",      "lang": "English"},
    "afroswing":           {"tag": "afroswing",          "vibe": "chill",      "lang": "Afrobeats"},
    "uk afrobeats":        {"tag": "afroswing",          "vibe": "chill",      "lang": "Afrobeats"},
    "singeli":             {"tag": "singeli",            "vibe": "intense",    "lang": "Afrobeats"},
    "kwaito":              {"tag": "kwaito",             "vibe": "party",      "lang": "Afrobeats"},
    "kwela":               {"tag": "kwela",              "vibe": "happy",      "lang": "Afrobeats"},
    "juju music":          {"tag": "juju",               "vibe": "soulful",    "lang": "Afrobeats"},
    "mbalax":              {"tag": "mbalax",             "vibe": "party",      "lang": "Afrobeats"},
    "ethio jazz":          {"tag": "ethio-jazz",         "vibe": "soulful",    "lang": "Afrobeats"},
    "taarab":              {"tag": "taarab",             "vibe": "romantic",   "lang": "Afrobeats"},
    "kuduro":              {"tag": "kuduro",             "vibe": "party",      "lang": "Afrobeats"},
    "rai":                 {"tag": "rai",                "vibe": "party",      "lang": "Arabic"},
    "levantine indie":     {"tag": "arabic pop",         "vibe": "indie_folk", "lang": "Arabic"},
    "persian pop":         {"tag": "persian pop",        "vibe": "happy",      "lang": "Any"},
    "iran pop":            {"tag": "persian pop",        "vibe": "happy",      "lang": "Any"},
    "turkish pop":         {"tag": "turkish pop",        "vibe": "happy",      "lang": "Any"},
    "v-pop":               {"tag": "v-pop",              "vibe": "happy",      "lang": "Any"},
    "vinahouse":           {"tag": "vinahouse",          "vibe": "party",      "lang": "Any"},
    "t-pop":               {"tag": "t-pop",              "vibe": "happy",      "lang": "Any"},
    "luk thung":           {"tag": "luk thung",          "vibe": "soulful",    "lang": "Any"},
    "c-pop":               {"tag": "c-pop",              "vibe": "happy",      "lang": "Any"},
    "mandopop":            {"tag": "mandopop",           "vibe": "happy",      "lang": "Any"},
    "cantopop":            {"tag": "cantopop",           "vibe": "happy",      "lang": "Any"},
    "p-pop":               {"tag": "p-pop",              "vibe": "happy",      "lang": "Any"},
    "kundiman":            {"tag": "kundiman",           "vibe": "romantic",   "lang": "Any"},
    "pinoy indie":         {"tag": "pinoy indie",        "vibe": "indie_folk", "lang": "Any"},
    "k-rnb":               {"tag": "k-rnb",              "vibe": "romantic",   "lang": "Korean"},
    "k-hip-hop":           {"tag": "k-hip-hop",          "vibe": "hype",       "lang": "Korean"},
    "shibuya-kei":         {"tag": "shibuya-kei",        "vibe": "indie_folk", "lang": "Japanese"},
    "enka":                {"tag": "enka",               "vibe": "heartbreak", "lang": "Japanese"},
    "j-indie":             {"tag": "j-indie",            "vibe": "indie_folk", "lang": "Japanese"},
    "soukous":             {"tag": "soukous",            "vibe": "party",      "lang": "Afrobeats"},
    "ndombolo":            {"tag": "ndombolo",           "vibe": "party",      "lang": "Afrobeats"},
    "benga":               {"tag": "benga",              "vibe": "happy",      "lang": "Afrobeats"},
    "norteño":             {"tag": "norteño",            "vibe": "soulful",    "lang": "Spanish"},
    "banda sinaloense":    {"tag": "banda",              "vibe": "party",      "lang": "Spanish"},
    "tejano":              {"tag": "tejano",             "vibe": "party",      "lang": "Spanish"},
    "nueva cancion":       {"tag": "nueva canción",      "vibe": "soulful",    "lang": "Spanish"},
    "tropicalia":          {"tag": "tropicália",         "vibe": "dreamy",     "lang": "Portuguese"},
    "axe music":           {"tag": "axé",                "vibe": "party",      "lang": "Portuguese"},
    "rajasthani folk":     {"tag": "rajasthani folk",    "vibe": "soulful",    "lang": "Hindi"},
    "rajasthani pop":      {"tag": "rajasthani",         "vibe": "happy",      "lang": "Hindi"},
    "marwadi":             {"tag": "marwadi",            "vibe": "soulful",    "lang": "Hindi"},
    "odia pop":            {"tag": "odia",               "vibe": "happy",      "lang": "Hindi"},
    "sambalpuri":          {"tag": "sambalpuri",         "vibe": "party",      "lang": "Hindi"},
    "garhwali pop":        {"tag": "garhwali",           "vibe": "soulful",    "lang": "Hindi"},
    "pahadi pop":          {"tag": "pahari folk",        "vibe": "calm",       "lang": "Hindi"},
    "delhi indie":         {"tag": "delhi indie",        "vibe": "indie_folk", "lang": "English"},
    "mumbai indie":        {"tag": "hindi indie",        "vibe": "indie_folk", "lang": "Hindi"},
    "bangalore indie":     {"tag": "hindi indie",        "vibe": "indie_folk", "lang": "English"},
    "desi emo rap":        {"tag": "desi hip hop",       "vibe": "heartbreak", "lang": "Hindi"},
    "desi trap":           {"tag": "desi hip hop",       "vibe": "hype",       "lang": "Hindi"},
    "indie electronica":   {"tag": "indie electronic",   "vibe": "chill",      "lang": "English"},
    ...
    # ── v6.3: 2024 emerging genres + remaining regional gaps ─────────────────
    # Afro drill / afro trap (fast-growing 2024)
    "afro drill":          {"tag": "afro drill",         "vibe": "hype",       "lang": "Afrobeats"},
    "uk afrobeats":        {"tag": "afroswing",          "vibe": "chill",      "lang": "Afrobeats"},
    "naija pop":           {"tag": "naija pop",          "vibe": "party",      "lang": "Afrobeats"},
    "alte":                {"tag": "alte",               "vibe": "chill",      "lang": "Afrobeats"},
    "alte cruise":         {"tag": "alte",               "vibe": "chill",      "lang": "Afrobeats"},
    "azonto":              {"tag": "azonto",             "vibe": "party",      "lang": "Afrobeats"},
    "hiplife":             {"tag": "hiplife",            "vibe": "hype",       "lang": "Afrobeats"},
    "bongo flava":         {"tag": "bongo flava",        "vibe": "hype",       "lang": "Afrobeats"},
    "taarab":              {"tag": "taarab",             "vibe": "romantic",   "lang": "Afrobeats"},
    "semba":               {"tag": "semba",              "vibe": "romantic",   "lang": "Afrobeats"},
    "makossa":             {"tag": "makossa",            "vibe": "party",      "lang": "Afrobeats"},
    # Latin gaps
    "regional mexicano":   {"tag": "regional mexicano",  "vibe": "soulful",    "lang": "Spanish"},
    "norteño":             {"tag": "norteño",            "vibe": "soulful",    "lang": "Spanish"},
    "tejano":              {"tag": "tejano",             "vibe": "party",      "lang": "Spanish"},
    "grupero":             {"tag": "grupero",            "vibe": "soulful",    "lang": "Spanish"},
    "corridos":            {"tag": "corridos tumbados",  "vibe": "intense",    "lang": "Spanish"},
    "dembow":              {"tag": "dembow",             "vibe": "party",      "lang": "Spanish"},
    "new flamenco":        {"tag": "nuevo flamenco",     "vibe": "soulful",    "lang": "Spanish"},
    "axe music":           {"tag": "axé",                "vibe": "party",      "lang": "Portuguese"},
    "tropicalia":          {"tag": "tropicália",         "vibe": "dreamy",     "lang": "Portuguese"},
    "forro":               {"tag": "forró",              "vibe": "party",      "lang": "Portuguese"},
    # Southeast Asian
    ...
    "t-pop":               {"tag": "t-pop",              "vibe": "happy",      "lang": "Any"},
    "luk thung":           {"tag": "luk thung",          "vibe": "soulful",    "lang": "Any"},
    "mor lam":             {"tag": "mor lam",            "vibe": "party",      "lang": "Any"},
    "c-pop":               {"tag": "c-pop",              "vibe": "happy",      "lang": "Any"},
    "mandopop":            {"tag": "mandopop",           "vibe": "happy",      "lang": "Any"},
    "cantopop":            {"tag": "cantopop",           "vibe": "happy",      "lang": "Any"},
    "p-pop":               {"tag": "p-pop",              "vibe": "happy",      "lang": "Any"},
    "kundiman":            {"tag": "kundiman",           "vibe": "romantic",   "lang": "Any"},
    "pinoy indie":         {"tag": "pinoy indie",        "vibe": "indie_folk", "lang": "Any"},
    "opm":                 {"tag": "opm",                "vibe": "happy",      "lang": "Any"},
    "dangdut":             {"tag": "dangdut",            "vibe": "party",      "lang": "Any"},
    "dangdut koplo":       {"tag": "dangdut koplo",      "vibe": "party",      "lang": "Any"},
    "j-indie":             {"tag": "j-indie",            "vibe": "indie_folk", "lang": "Japanese"},
    "shibuya-kei":         {"tag": "shibuya-kei",        "vibe": "indie_folk", "lang": "Japanese"},
    "enka":                {"tag": "enka",               "vibe": "heartbreak", "lang": "Japanese"},
    "k-rnb":               {"tag": "k-rnb",              "vibe": "romantic",   "lang": "Korean"},
    ...
    # Middle Eastern gaps
    "rai":                 {"tag": "rai",                "vibe": "party",      "lang": "Arabic"},
    "levantine indie":     {"tag": "arabic indie",       "vibe": "indie_folk", "lang": "Arabic"},
    "turkish pop":         {"tag": "turkish pop",        "vibe": "happy",      "lang": "Any"},
    "arabesk":             {"tag": "arabesk",            "vibe": "heartbreak", "lang": "Any"},
    "persian pop":         {"tag": "persian pop",        "vibe": "happy",      "lang": "Any"},
    # Indian regional remaining
    "odia pop":            {"tag": "odia",               "vibe": "happy",      "lang": "Hindi"},
    "sambalpuri":          {"tag": "sambalpuri",         "vibe": "party",      "lang": "Hindi"},
    "garhwali pop":        {"tag": "garhwali",           "vibe": "soulful",    "lang": "Hindi"},
    "pahadi pop":          {"tag": "pahari folk",        "vibe": "calm",       "lang": "Hindi"},
    "konkani pop":         {"tag": "konkani",            "vibe": "happy",      "lang": "Any"},
    "tulu music":          {"tag": "tulu",               "vibe": "happy",      "lang": "Kannada"},
    "nepali pop":          {"tag": "nepali pop",         "vibe": "happy",      "lang": "Any"},
    "nepali folk":         {"tag": "nepali folk",        "vibe": "soulful",    "lang": "Any"},
    "maithili folk":       {"tag": "maithili",           "vibe": "soulful",    "lang": "Hindi"},
    "raga rock":           {"tag": "raga rock",          "vibe": "rock",       "lang": "Hindi"},
    "desi emo":            {"tag": "desi hip hop",       "vibe": "heartbreak", "lang": "Hindi"},
    # Electronic subgenre gaps
    "footwork":            {"tag": "footwork",           "vibe": "intense",    "lang": "English"},
    "juke":                {"tag": "footwork",           "vibe": "intense",    "lang": "English"},
    "liquid dnb":          {"tag": "liquid drum and bass","vibe": "chill",     "lang": "English"},
    "liquid drum and bass":{"tag": "liquid drum and bass","vibe": "chill",     "lang": "English"},
    "neurofunk":           {"tag": "neurofunk",          "vibe": "dark",       "lang": "English"},
    "speed garage":        {"tag": "speed garage",       "vibe": "party",      "lang": "English"},
    "ghettotech":          {"tag": "ghettotech",         "vibe": "intense",    "lang": "English"},
    "hypnagogic pop":      {"tag": "hypnagogic pop",     "vibe": "dreamy",     "lang": "English"},
    "freak folk":          {"tag": "freak folk",         "vibe": "indie_folk", "lang": "English"},
    "folktronica":         {"tag": "folktronica",        "vibe": "chill",      "lang": "English"},
    "comfy synth":         {"tag": "lo-fi",              "vibe": "chill",      "lang": "English"},
    "witch house":         {"tag": "witch house",        "vibe": "dark",       "lang": "English"},
    "deconstructed club":  {"tag": "experimental",       "vibe": "industrial", "lang": "English"},
    "afro house":          {"tag": "afro house",         "vibe": "party",      "lang": "Afrobeats"},
    "melodic techno":      {"tag": "melodic techno",     "vibe": "industrial", "lang": "English"},
    "minimal techno":      {"tag": "minimal techno",     "vibe": "industrial", "lang": "English"},
    "progressive house":   {"tag": "progressive house",  "vibe": "euphoric",   "lang": "English"},
    "microhouse":          {"tag": "minimal techno",     "vibe": "chill",      "lang": "English"},
}
...
VIBE_MAP: dict[str, dict] = {
    ...
    "tropical": {
        "keywords": [
            ...
            "palm trees", "vacation", "humidity", "tropical", "jungle", 
    ...
    "happy": {
        "keywords": [
            ...
            "sunflower", "sunflowers", "golden", "bright", "warm", "sweet",
            "bloom", "blossom", "peach", "honey", "caramel", "chocolate",
            "yellow", "cozy", "fluffy", "cottagecore", "sunday morning",
            "warm hug", "feels like a hug", "summer day", "clear sky",
