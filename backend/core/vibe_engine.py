...
SYNONYMS: dict[str, list[str]] = {
    ...
    # ── lost / isolated / adrift / disconnected (NEW) ─────────────────────────
    "lost":                  ["heartbreak", "dreamy"],
    "feeling lost":          ["heartbreak", "dreamy"],
    "lost in a crowd":       ["heartbreak", "dreamy"],
    "lost in the crowd":     ["heartbreak", "dreamy"],
    "lost in a sea of":      ["heartbreak", "dreamy"],
    "invisible":             ["heartbreak", "dark"],
    "invisible in a crowd":  ["heartbreak", "dark"],
    "alone in a crowd":      ["heartbreak", "dreamy"],
    "surrounded but lonely": ["heartbreak", "dark"],
    "crowd but alone":       ["heartbreak", "dark"],
    "surrounded by people":  ["heartbreak", "dreamy"],
    "nobody sees me":        ["heartbreak", "dark"],
    "no one notices":        ["heartbreak", "dark"],
    "unnoticed":             ["heartbreak", "dark"],
    "drifting":              ["dreamy", "heartbreak"],
    "adrift":                ["dreamy", "heartbreak"],
    "floating away":         ["dreamy", "heartbreak"],
    "disconnected":          ["heartbreak", "dark"],
    "detached":              ["dark", "dreamy"],
    "dissociated":           ["dark", "dreamy"],
    "zoned out sad":         ["heartbreak", "dreamy"],
    "going through the motions": ["heartbreak", "dark"],
    "existing but not living": ["dark", "heartbreak"],
    "background character":  ["heartbreak", "dreamy"],
    "fading into the background": ["heartbreak", "dreamy"],
    "watching from afar":    ["dreamy", "heartbreak"],
    "spectator of my own life": ["dark", "dreamy"],
    "overwhelmed but numb":  ["dark", "heartbreak"],
    "too much noise":        ["dark", "intense"],
    "overstimulated":        ["dark", "intense"],
    "people everywhere but":  ["heartbreak", "dreamy"],
    "busy place but empty":   ["heartbreak", "dark"],
    "city loneliness":       ["heartbreak", "dreamy"],
    "urban lonely":          ["heartbreak", "dreamy"],
    "stranger in my own":    ["heartbreak", "dark"],
    "out of place":          ["heartbreak", "dark"],
    "don't belong":          ["heartbreak", "dark"],
    "belong nowhere":        ["heartbreak", "dark"],
    "where do i fit":        ["heartbreak", "dark"],
    "identity lost":         ["dark", "heartbreak"],
    "losing myself":         ["heartbreak", "dark"],
    "who am i":              ["dark", "heartbreak"],
    "questioning everything": ["dark", "heartbreak"],
    "existential":           ["dark", "cinematic"],
    "existential dread":     ["dark", "cinematic"],
    "meaning of life":       ["dark", "cinematic"],
...
VIBE_MAP: dict[str, dict] = {
    ...
    "dreamy": {
        ...
        "phrases": [
            ...
            "lost in a crowd", "drifting through a crowd", "watching the world go by",
            "invisible in a sea of faces", "crowd of strangers", "city at night alone",
    ...
    "heartbreak": {
        "keywords": [
            ...
            "lost", "feeling lost", "adrift", "drifting", "invisible", "unnoticed",
            "alone in a crowd", "lost in a crowd", "disconnected", "detached",
            "out of place", "don't belong", "nobody sees me", "fading",
            "losing myself", "background character", "going through the motions",
        ...
        "phrases": [
            ...
            "feeling like im lost", "feeling like i'm lost", "lost in a crowd",
            "lost in the crowd", "lost in a sea", "alone in a crowd",
            "surrounded but lonely", "invisible in a crowd",
            "nobody notices me", "nobody sees me", "fading into the background",
            "city but lonely", "busy but empty", "out of place", "don't belong",
            "surrounded by people but", "people everywhere but",
