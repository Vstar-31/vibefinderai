...
VIBE_MAP: dict[str, dict] = {
    ...
    "hype": {
        ...
        "bpm": "130-175",
        "genres": ["Trap", "Phonk", "Hardstyle", "Rage Rap", "EDM", "UK Drill", "Bass Music", "Trap Metal", "Drift Phonk", "Jersey Club", "Midtempo Bass", "Brostep", "Tearout", "Color Bass", "Desi Hip Hop", "Indian Hip Hop", "Gully Rap", "Hindi Rap", "Desi Drill", "Mumbai Rap"],
    },
